  ...
  return (
    ...
    >
      <article className="prose prose-lg max-w-none dark:prose-invert prose-headings:font-bold prose-p:leading-relaxed prose-ul:my-4 prose-ol:my-4 prose-li:my-1 text-foreground">
        ...
        <p>
          שם, אימייל, פרטי הילד (לצורך חיפוש בלבד: שם ושנת לידה). בנוסף, בעת ניסיון לפתיחת מסר אנו שומרים גיבוב מאוננן של כתובת ה-IP (לא את הכתובת עצמה) — לצורכי אבטחה וזיהוי ניסיונות חוזרים בלבד, ללא אפשרות לזהות משתמשים.
        </p>
